...
echo "0 * * * * cd /root && sudo certbot certonly  -i nginx --dns-route53 --no-redirect --non-interactive --agree-tos --register-unsafely-without-email --expand" >> /var/spool/cron/root
